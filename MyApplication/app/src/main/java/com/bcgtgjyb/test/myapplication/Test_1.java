...
import com.bcgtgjyb.test.mylibrary.AnimationCirculateListener;
...
public class Test_1 extends ActionBarActivity {
    ...
    List l2=m.getRandomDate(50, 1);
    List l3=m.getRandomDate(50, 2);
    List l4=m.getRandomDate(50, 3);
    List l5=m.getRandomDate(50, 4);
    @Override
    ...
    private void setRondomMove(){
        ...
        list.add(a.setTranslation(b4,(List)l4.get(0),(List)l4.get(1),1000));
        list.add(a.setTranslation(b2, (List) l2.get(0), (List) l2.get(1), 1000));
        list.add(a.setTranslation(b3,(List)l3.get(0),(List)l3.get(1),1000));
        list.add(a.setTranslation(b5,(List)l5.get(0),(List)l5.get(1),1000));
    ...
    class MyButtonListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if(open==-1){
                ...
                b3List=movePath.getCurveData(getTranslation(b3, coordinate), 80, 1);
                b2List=movePath.getCurveData(getTranslation(b2, coordinate), 80, 1);
                b4List=movePath.getCurveData(getTranslation(b4, coordinate), 80, 1);
                b5List=movePath.getCurveData(getTranslation(b5, coordinate), 80, 1);
